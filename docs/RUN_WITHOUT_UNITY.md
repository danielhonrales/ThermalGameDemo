...
1. Download `ThermalGameDemo-LAN-install-kit.zip` from the [prototype GitHub release](https://github.com/danielhonrales/ThermalGameDemo/releases/tag/quest-lan-prototype-2026-09-23) and unzip it. From the unzipped folder, use the commands in [SETUP.md](SETUP.md), starting with **Prepare the router and devices**. Skip **Clone and build the Unity project**; the APK is already in the bundle as `ThermalGameDemo-Quest-LAN.apk`.
