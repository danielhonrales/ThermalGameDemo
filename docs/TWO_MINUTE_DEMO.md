...
5. **WATCH OUT FOR LASERS** appears before the first sweep at 10 seconds. Later beams arrive at 32, 45, and 55 seconds, with a brief amber preview at the side before each one. The status below the clock shows the current phase and counts down to upcoming beams. A low hum grows as a sweep approaches. Duck under every head-height beam. A laser hit removes health even while shielding.
