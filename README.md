...
To run the demo without Unity, download the [latest install bundle](https://github.com/danielhonrales/ThermalGameDemo/releases/tag/quest-lan-60s-2026-09-25-r2) and follow the [APK install guide](docs/RUN_WITHOUT_UNITY.md). Both headsets use the same APK and choose host/client automatically. To rebuild or edit the game, use the [setup and deployment guide](docs/SETUP.md). See [external assets](docs/EXTERNAL_ASSETS.md) before opening the Unity project on a new computer.
