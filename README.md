...
To run the demo without Unity, use the [APK install guide](docs/RUN_WITHOUT_UNITY.md) and its matching install bundle. To rebuild or edit the game, use the [setup and deployment guide](docs/SETUP.md). See [external assets](docs/EXTERNAL_ASSETS.md) before opening the Unity project on a new computer.
