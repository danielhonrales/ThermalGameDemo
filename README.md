...
To run the demo without Unity, download the [prototype install bundle](https://github.com/danielhonrales/ThermalGameDemo/releases/tag/quest-lan-prototype-2026-09-23) and follow the [APK install guide](docs/RUN_WITHOUT_UNITY.md). To rebuild or edit the game, use the [setup and deployment guide](docs/SETUP.md). See [external assets](docs/EXTERNAL_ASSETS.md) before opening the Unity project on a new computer.
